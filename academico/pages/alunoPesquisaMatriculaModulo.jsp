...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Pesquisa para Matrícula (Módulo)  &nbsp;
			</legend>
			<html:form method="action" action="actionMatricula" focus="mtcnmal">
			<html:hidden property="m" value="pesquisaMatriculaModulo"/>
			<table>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td>
						<a href="actionMatriculaModulo.do?m=novo&alncodg=<bean:write name="b" property="alncodg"/>">
