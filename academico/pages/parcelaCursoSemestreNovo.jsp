...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				<bean:write name="semestre" property="smcdesc"/> > <bean:write name="cursosemestre" property="cmcdccs"/> (<bean:write name="cursosemestre" property="cmcdcue"/>) > Nova Parcela do Curso
			</legend>
			<html:errors/>
			<html:form action="/actionParcelaCursoSemestre" focus="pcdvenc">
			<html:hidden property="m" value="cadastro"/>
			<input type="hidden" name="pcncgcm" value="<bean:write name="cursosemestre" property="cmncodg"/>">
			<table style="width: 500px;">
			<tbody>
				<tr>
					<th colspan="2">
						Nova Parcela do Curso do Semestre
					</th>
				</tr>
				<tr>
					<td>
