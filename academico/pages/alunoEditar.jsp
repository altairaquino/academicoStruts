		...
		<fieldset>
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2">
						<html:text property="alccpf" size="15" maxlength="14" onkeyup="criaMascara(this, '###.###.###-##');" disabled="true"/>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td colspan="2">
						<html:text property="alctiel" size="11" maxlength="10" onkeyup="criaMascara(this, '##########');"/>&nbsp;
