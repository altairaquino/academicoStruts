...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Pesquisa de Alunos para Documentos &nbsp;
			</legend>
			<html:form method="action" action="actionAluno" focus="alcnome">
			<html:hidden property="m" value="pesquisaDocumento"/>
			<table>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td>
						<a href="actionAluno.do?m=documentos&alncodg=<bean:write name="b" property="alncodg"/>">
