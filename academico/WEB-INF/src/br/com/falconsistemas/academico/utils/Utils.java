...
public class Utils {
	 ...
	 * @param str String passada para modificaï¿½ï¿½o.
	...
	public static String getNomeMes(int mes){
		...
		switch (mes) {
			...
			default: smes = "Inexistente";break;
		}
	...
	public static String getNomeDia(int dia){
		...
		switch (dia) {
			...
			case 2:	sdia = "Segunda-Feira";break;
			case 3:	sdia = "Terça-Feira";break;
			case 4:	sdia = "Quarta-Feira";break;
			case 5:	sdia = "Quinta-Feira";break;
			case 6:	sdia = "Sexta-Feira";break;
			case 7:	sdia = "Sábado";break;
			default: sdia = "Inexistente";break;
		}
